...
bars = [
    plt.bar(x - width, merged["Lkm2023"], width, label="2023"),
    plt.bar(x, merged["Lkm2024"], width, label="2024"),
    plt.bar(x + width, merged["Lkm2025"], width, label="2025") # Lisää ,
    # Lisää vuosi tähän esim. ptl.bar(x + width * 2, merge["Lmk2026"], width, label="2026")
]
